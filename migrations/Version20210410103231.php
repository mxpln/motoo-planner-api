 ...
 */
final class Version20210410103231 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, excerpt LONGTEXT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE checklist (id INT AUTO_INCREMENT NOT NULL, roadbook_id INT DEFAULT NULL, task VARCHAR(255) NOT NULL, checked TINYINT(1) NOT NULL, INDEX IDX_5C696D2F7952527A (roadbook_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE roadbook (id INT AUTO_INCREMENT NOT NULL, picture_url_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, status INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, trip_start DATETIME NOT NULL, share_link VARCHAR(255) NOT NULL, INDEX IDX_B31204D7102B6CF7 (picture_url_id), INDEX IDX_B31204D7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE step (id INT AUTO_INCREMENT NOT NULL, roadbook_id INT DEFAULT NULL, suggestion_id INT DEFAULT NULL, type_id INT NOT NULL, step_date DATETIME NOT NULL, step_lat DOUBLE PRECISION NOT NULL, step_long DOUBLE PRECISION NOT NULL, title VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_43B9FE3C7952527A (roadbook_id), UNIQUE INDEX UNIQ_43B9FE3CA41BB822 (suggestion_id), INDEX IDX_43B9FE3CC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(180) NOT NULL, icon VARCHAR(180) NOT NULL, slug VARCHAR(45) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE roadbook ADD CONSTRAINT FK_B31204D7102B6CF7 FOREIGN KEY (picture_url_id) REFERENCES media_object (id)');
        ...
        $this->addSql('ALTER TABLE step ADD CONSTRAINT FK_43B9FE3CC54C8C93 FOREIGN KEY (type_id) REFERENCES type (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE roadbook DROP FOREIGN KEY FK_B31204D7102B6CF7');
